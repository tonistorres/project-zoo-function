...
describe('7 - Crie um mapeamento geográfico das espécies e seus animais', () => {
  ...
  it('se somente a opção `sex: female` for especificada, retorna animais categorizados por localização', () => {
    ...
    // Fazendo abstração do problema: O teste aqui descrito me passa um parâmetro que devo utilizar na minha função
    // esse parâmetro pode ser capturado a partir da digitação do usuário ou simplesmente uma api passou para minha 
    // funçáo e agora por meio da minha fução devo fazer a busca desses dadso de formar retornoar o que é esperado 
    // na const expected 
    const options = {
      sex: 'female'
    };
